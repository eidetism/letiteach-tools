...
- `Назад`;
- `Следующий вопрос`;
- `Просмотр ×8` для реального ускоренного воспроизведения скрытого видео;
- `Показать лекцию`.

Скрипт автоматически повторяет поиск вопросов, когда LETIteach динамически загружает другой блок курса.

Кнопка ускоренного просмотра не изменяет `watch_times` вручную и не отправляет принудительный `completion: 1`. Засчитает ли LETIteach ускоренное воспроизведение как полный просмотр, зависит от серверных правил курса. Встроенный вопрос может поставить видео на паузу, после ответа воспроизведение нужно запустить повторно.
